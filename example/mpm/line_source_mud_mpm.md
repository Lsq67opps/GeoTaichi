...
> Note: This guide is written primarily in Chinese for authorship consistency. Below is an English title and summary for quick orientation; the detailed walkthrough that follows is unchanged.
...
mpm.add_material(model="LinearElastic", material={  # 泥沙团，按 αs0=0.606
    "MaterialID":       2,
    "YoungModulus":     5e4,       # 提高会加强骨架刚度、降低扩散；减小则泥沙团更易展开
    "PoissonRatio":     0.3,
    "SolidDensity":     2650.,
    "FluidDensity":     rho_f,
